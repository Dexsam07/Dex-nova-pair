            ...
            const handleConnectionUpdate = async (update) => {
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        const sessionDexbot = fs.readFileSync(dirs + '/creds.json');
                        ...
                        if (userJid) {
                            ...
                            await sock.sendMessage(userJid, {
                                ...
                                caption: `🎬 *DEX-BOT-MD V2.0 Full Setup Guide!*\n\n🚀 stable now + New Commands + Fast AI Chat\n📺 Watch Now: https://youtu.be/Hmp17yyU9Xc?si=AR0KfSeTiCed7R2i`
                            });
